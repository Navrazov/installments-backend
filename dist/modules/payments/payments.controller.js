...
let PaymentsController = class PaymentsController {
    ...
    async getStats(req, dateFrom, dateTo) {
        const orgId = req.user.organizationId;
        return this.paymentsService.getStats(orgId, dateFrom, dateTo);
    }
    async getPaymentsByDeal(req, dealId) {
        const orgId = req.user.organizationId;
...
__decorate([
    (0, common_1.Get)('by-deal/:dealId'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('dealId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], PaymentsController.prototype, "getPaymentsByDeal", null);
__decorate([
    (0, common_1.Post)('early-repayment'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], PaymentsController.prototype, "earlyRepayment", null);
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, query_payment_dto_1.QueryPaymentDto]),
    __metadata("design:returntype", Promise)
