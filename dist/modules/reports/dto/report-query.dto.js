...
exports.DynamicsQueryDto = exports.ReportQueryDto = void 0;
...
class DynamicsQueryDto {
    constructor() {
        this.monthsBack = 12;
    }
}
exports.DynamicsQueryDto = DynamicsQueryDto;
__decorate([
    (0, class_validator_1.IsOptional)(),
...
], DynamicsQueryDto.prototype, "monthsBack", void 0);
